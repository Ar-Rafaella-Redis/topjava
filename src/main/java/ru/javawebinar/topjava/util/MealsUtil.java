...
public class MealsUtil {
    ...
    public static List<MealTo> getMealsTo(){
        return  filteredByStreams(MEALS, LocalTime.of(0, 0), LocalTime.of(23, 59), DEFAULT_CALORIES_PER_DAY);
    }

    public static List<MealTo> getMealsTo(Collection<Meal> meals, int caloriesPerDay){
