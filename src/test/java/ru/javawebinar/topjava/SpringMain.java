...
public class SpringMain {
    public static void main(String[] args) {
        ...
        try (ConfigurableApplicationContext appCtx = new ClassPathXmlApplicationContext("spring/spring-app.xml","classpath:spring/spring-db.xml")) {
          ...
          //  adminUserController.create(new User(null, "userName", "email2@mail.ru", "password", Role.ROLE_ADMIN));
            System.out.println();

            MealRestController mealController = appCtx.getBean(MealRestController.class);
          //  System.out.println(mealController.getAll().size());
            System.out.println(SecurityUtil.authUserId());
            Meal adminMeal = mealController.get(100007);
            System.out.println(adminMeal);
